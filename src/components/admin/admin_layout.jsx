...
function AdminLayout() {
    ...
    const [role, setRole] = useState(location.state.loginRole);
    return (
        <>
                ...
                <div className="sidebar pe-4 pb-3">
                    <nav className="navbar bg-light navbar-light">
                        ...
                        <div className="navbar-nav w-100">
                            ...
                            <a className="sidebar_nav nav-item nav-link">
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="user" state={{ role: role }}>User</Link></a>
                            <a className="sidebar_nav nav-item nav-link">
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="order" state={{ role: role }}>Orders</Link></a>
                            <a className="sidebar_nav nav-item nav-link">
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="attendance">Attendance</Link></a>
                            <a className="sidebar_nav nav-item nav-link">
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="leaves" state={{ role: role }}>Leaves</Link></a >
                            <a className="sidebar_nav nav-item nav-link" >
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="salary" state={{ role: role }}>Salary</Link></a >
                            <a className="sidebar_nav nav-item nav-link" >
                                <FontAwesomeIcon icon={faTachometerAlt} className="fa me-2" />
                                <Link to="daily_expense">Daily Expense</Link></a >
